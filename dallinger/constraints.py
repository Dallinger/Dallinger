...
Originally the constraints.txt file was generated by pip-compile. Now we use uv,
which is faster and supports resolving against the Python version requested by
the experiment's .python-version file.
"""
