...
def _get_constraints_signature(input_path: Path, extras: Optional[List[str]] = None) -> str:
    """
...
def _constraints_up_to_date(input_path: Path, extras: Optional[List[str]] = None) -> bool:
    assert_python_version_file_presence()
    extras = extras or []
...
def _get_dallinger_reference(input_path: Path, extras: Optional[List[str]] = None) -> str:
