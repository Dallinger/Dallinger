...
class TestExperimentBaseClass(object):
    ...
    def test_assignment_submitted__approves_and_records_base_payment(
    ...
    def test_assignment_submitted__pays_no_bonus_if_less_than_one_cent(self, a, exp):
        participant = a.participant()
        end_time = datetime(2000, 1, 1)
    ...
    def test_assignment_submitted__sets_end_time(self, a, exp):
        participant = a.participant()
        end_time = datetime(2000, 1, 1)
    ...
    def test_assignment_submitted__noop_if_already_approved_worker(self, a, exp):
        participant = a.participant()
    ...
    def test_assignment_submitted__failed_data_check(self, a, exp):
        participant = a.participant()
    ...
    def test_assignment_submitted__failed_attention_check(self, a, exp):
        participant = a.participant()
