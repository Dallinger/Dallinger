...
class TestGenerateConstraints:
    ...
    def test_constraints_dallinger_release(self, in_tempdir):
        with open("requirements.txt", "w") as f:
            f.write("dallinger==11.4.0")
        generate_constraints()
        assert Path("constraints.txt").exists()
        assert _constraints_autogenerated(Path("constraints.txt"))
    ...
    def test_constraints_dallinger_commit(self, in_tempdir):
    ...
    def test_constraints_psynet(self, in_tempdir):
        with open("requirements.txt", "w") as f:
    ...
    def test_caching(self, tempdir, in_tempdir):
    ...
    def test_constraints_written_manually(self, in_tempdir, tempdir):
    ...
    def test_check_constraints(self, in_tempdir, tempdir):
        with open("requirements.txt", "w") as f:
            f.write("dallinger==11.4.0")
...
@pytest.mark.slow
def test_legacy_interface(in_tempdir):
...
@pytest.mark.slow
def test_impossible_resolution(in_tempdir):
    with open("requirements.txt", "w") as f:
...
def test_constraints_run_from_wrong_directory(tempdir):
